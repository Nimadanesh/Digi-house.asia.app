...
> **ACTIVE PROFILE: FractionalLuxe** (hand-edited 2026-08-25) — brand = Telegram azure `#229ED9` + slate ink `#17212B`. Light skin below is the primary deliverable skin.
...
|---|---|---|---|
| `paper` | Page background, default node fill | `#f4f6f8` (azure-mist) | `#17212b` (slate ink) |
| `paper-2` | Diagram container bg, secondary fill | `#e9eef2` | `#1d2a36` |
| `ink` | Primary text, primary stroke | `#17212b` (slate ink) | `#e9eef2` |
| `muted` | Secondary text, default arrow stroke | `#46586a` (harbor slate) | `#8fa3b5` |
| `soft` | Sublabels, boundary labels | `#7b8b9b` | `#6d8093` |
| `rule` | Hairline borders | `rgba(23,33,43,0.12)` | `rgba(233,238,242,0.12)` |
| `rule-solid` | Stronger borders, baselines | `#b9c4cd` | `rgba(143,163,181,0.25)` |
| `accent` | Focal / 1–2 max per diagram | `#229ed9` (telegram azure) | `#41b1e8` |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(34,158,217,0.09)` | `rgba(65,177,232,0.10)` |
| `link` | HTTP/API calls, external arrows | `#17618c` (deep azure) | `#5fa9d4` |

> **Brand palette source:** FractionalLuxe locked brand — telegram azure `#229ED9`, slate ink `#17212B`. Paper/muted/soft/rule are derived in the ink hue family to stay quiet so azure keeps full focal signal; `link` is a deepened azure for external arrows, kept clearly darker than the accent.
