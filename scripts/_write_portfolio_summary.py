...
content = [
    '"use client";',
    "// File responsibility: Portfolio summary hero (Fable Portfolio Summary).",
...
fixed = []
for line in content:
    line= line.replace("0∸.6875rem", "0.6875rem")
    line = line.replace("te stId", "testId")
    line = line.replace("\u00a0", " ")
    fixed.append(line)

Path("src/components/portfolio/PortfolioSummaryCard.tsx").write_text(
    "\n".join(fixed) + "\n", encoding="utf-8"
)
print("ok")
