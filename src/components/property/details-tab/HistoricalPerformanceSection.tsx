...
export function HistoricalPerformanceSection() {
  ...
  return (
    <section className="space-y-2" data-testid="details-historical">
      ...
      <Block className="rounded-[12px] p-5 shadow-sm ring-1 ring-border/50" data-testid="details-historical-card">
        ...
        <p className="pt-2 text-[0.6875rem] leading-relaxed text-muted-foreground/70">
          {t("historicalNote")}
        </p>
      </Block>
    </section>
