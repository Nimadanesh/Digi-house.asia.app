  ...
  return (
    <section className="space-y-2" data-testid="ownership-growth">
      ...
      <Block className="p-4 shadow-sm ring-1 ring-border/50 sm:p-5">
        <p
          className="whitespace-nowrap text-[1.375rem] font-bold leading-none tracking-tight tnum text-foreground"
            ...
            >
              ...
              <span className="flex shrink-0 items-center gap-1.5">
                ...
                <ChevronDown
                  ...
                  strokeWidth={1.75}
                  aria-hidden
                  className={`text-muted-foreground transition-transform duration-150 ease-out ${researchOpen ? "rotate-180" : ""}`}
                />
              </span>
            </button>
            {researchOpen ? (
