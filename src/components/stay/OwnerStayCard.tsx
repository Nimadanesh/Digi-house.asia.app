...
export function OwnerStayCard({
  ...
  return (
    <section className="space-y-2" data-testid="owner-stay-card">
      ...
      <Block className="space-y-3 p-4 shadow-sm ring-1 ring-border/50 sm:p-5">
        <div className="flex items-center gap-2.5">
          ...
          <p className="line-clamp-2 min-w-0 text-sm font-medium leading-snug tracking-[-0.01em] text-foreground">
        ...
        {isOwner ? (
          <div className="space-y-3">
            ...
            <span
              className="inline-flex rounded-full bg-surface-2/60 px-2.5 py-1 text-xs font-medium text-muted-foreground ring-1 ring-border/50"
            ...
            <button
              type="button"
              disabled
              className="flex h-[46px] w-full items-center justify-center rounded-[12px] bg-surface-2 text-sm font-semibold text-muted-foreground ring-1 ring-border/50"
